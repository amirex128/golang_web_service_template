...
type CreateMenu struct {
	...
	//لینک منو
	Link string `form:"link" json:"link" validation:"omitempty" example:"https://example.subdomain.selloora.conf/page/test" fake:"{url}"`
	//شناسه فروشگاه
...
type UpdateMenu struct {
	...
	//لینک منو
	Link string `form:"link" json:"link" validation:"omitempty" example:"https://example.subdomain.selloora.conf/page/test"`
	//شناسه منو بالا سری
